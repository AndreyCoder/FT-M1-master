...
// posición puede ser un único
// número u otro array anidado de números, determinar la suma de todos los 
...
var countArray = function (array) {
  ...
  return array.reduce((counter, item) => {
    const c = Array.isArray(item) ? countArray(item) : item
    return counter + c
  }, 0)
}

// const myArr = [1, [2, [3, 4]], [5, 6], 7];
// console.log(countArray(myArr));


// Implementar la función countProps: a partir de un objeto en el cual cada 
// propiedad puede contener
// cualquier tipo de dato, determinar la cantidad de propiedades de objetos 
...
//   c: [1, {a: 1}, 'Franco']
// }
// countProps(obj)--> Deberia devolver 10 ya que el objeto inicial 
// tiene 3 propiedades, pero a su vez
// dentro de a tenemos 3 propiedades mas, luego a3 tiene otras 3 y 
// por ultimo c tiene una extra.
...
// aquellos valores que no puedan castearse a numeros por 'Kiricocho' 
