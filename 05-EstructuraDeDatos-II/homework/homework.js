...
LinkedList.prototype.add = function (value) {
  ...
  if (!this.head) {
    ...
    // en caso de que la lista tenga nodos
...
(Luego de haber pasado todos los tests, a modo de ejercicio adicional, pueden 
modificar un poco la clase para que reciba la cantidad de buckets por parámetro 
...
(investigar el método charCodeAt de los strings) y calcula el módulo de ese número 
total por la cantidad de buckets; de esta manera determina la posición de la tabla 
...
Primero puedo chequear, con hasKey, si ya hay algo en la tabla con el nombre 
